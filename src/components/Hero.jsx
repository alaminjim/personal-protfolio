...
const profile = {
    ...
    skills: [
        ...
        'NextJS', 'Express', 'MySQL', 'MongoDB',
        'TypeScript', 'Git'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    developmentJourney: 2, 
    dedicated: true,  // Added this property
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Dedicated problem-solver 🔧 | Coding the
                  future 💻✨ & Learning new Technologies
                </p>
              </div>
